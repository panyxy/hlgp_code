...
try:
    ...
    from graph_partition.hlgp_sl.model.attention import MultiHeadAttention
...
class ResidualNorm(nn.Module):
    ...
    def forward(self, state_before, modified_after):
        ...
        # batch/layer norm
        if self.batchnorm:
            # expects [batch_size, emb_size, seq_len]
            # computing statistics on (batch_size, seq_len) slices.
